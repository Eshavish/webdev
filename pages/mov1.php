...
<div id="container-div">
        <div id="left-element">
          ...
          <div id="right-element">
           <input type="submit" id='back1' name='back1' value="Return to home page" />
           </div>
    </div>
	</br></br></br>	
       <div align="center">
	<font size="6" >Ranjhanaa</font>
		...
		<div id="main">			
		<div id="left-main">
		<img src="images/rj.jpg" height=200 width=300 />
		</div>
		<div id="right-main">
		<font size="4">
		  <font size= "4" >Rating:</font></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size ="4"  color ="#B266FF"; >  7.6/10 IMBD </font></br>
          </br>
		  <input type="submit" id="submit2" class="" name="submit2" value="Write Review" /></br></br>
Raanjhanaa is a 2013 Indian romantic drama film, directed by Anand L. Rai and written by Himanshu Sharma.<br/>The film is produced by Krishika Lulla under the banner Eros International<br/><pre>Director: Anand L. Rai
